...
if season:
        ...
        with c6:
            ...
            fig = px.line(xFGvsG,x='opposingTeam',y='xG',title='Expected vs Actual Goals Per Opponent')
            fig.add_trace(go.Scatter(x=xFGvsG['opposingTeam'], y=xFGvsG['goal'], mode='lines', name='Actual Goals', line=dict(color='red')))
            st.plotly_chart(fig)
